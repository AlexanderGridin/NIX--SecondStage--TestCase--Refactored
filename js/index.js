...
function initDynamicElements(){
   ...
   * Не успели придумать, как грамотно его обернуть.
   */
...
function initTable(){
   ...
   * Однако, если какой-то из элементов конфига убрать, таблица может сломаться, т.к. не успели добавить в класс нужные проверки...
   */
...
function initPagination(){
  /**
   * Основная идея была в том, чтобы сделать данную иннициализацию похожей на иннициализацию JS-плагина.
   * Однако, если какой-то из элементов конфига убрать, пагинация может сломаться, т.к. не успели добавить в класс нужные проверки...
   */
